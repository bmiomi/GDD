...
class consultas:
    ...
    @classmethod
    def Descuentos_Demadrugada(cls,ndistribuidor:str):
        ...
        distribuidor=distribuidor.get(ndistribuidor.lower())
